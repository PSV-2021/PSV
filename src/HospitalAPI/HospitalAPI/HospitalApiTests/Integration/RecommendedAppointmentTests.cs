...
namespace HospitalApiTests.Integration
{
    public class RecommendedAppointmentTests
    {
        ...
        public void Get_available_appointment_by_date_priority()
        {
            ...
            context.Add(new Appointment { Id = 4, StartTime = new DateTime(2021, 12, 12, 8, 30,0), DurationInMunutes = 30, ApointmentDescription = "", IsDeleted = false, DoctorId = 1, PatientId = 1, Canceled = false });
