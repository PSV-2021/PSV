    ...
    public partial class sprint5 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2021, 12, 27, 15, 31, 39, 677, DateTimeKind.Local).AddTicks(6141), "Brufen - 150, Palitreks - 100, Andol - 40", true },
                    { "4", new DateTime(2021, 12, 13, 15, 31, 39, 687, DateTimeKind.Local).AddTicks(7145), "Brufen - 10, Palitreks - 50, Andol - 35", true },
                    { "3", new DateTime(2022, 1, 3, 15, 31, 39, 687, DateTimeKind.Local).AddTicks(7120), "Brufen - 2, Palitreks - 2, Andol - 2", true },
                    { "2", new DateTime(2022, 1, 31, 15, 31, 39, 687, DateTimeKind.Local).AddTicks(6903), "Brufen - 120, Palitreks - 90, Andol - 50", false }
                });
