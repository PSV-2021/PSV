    ...
    public partial class firstMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2022, 1, 14, 19, 8, 37, 958, DateTimeKind.Local).AddTicks(762), "Brufen - 150, Palitreks - 100, Andol - 40", true },
                    { "2", new DateTime(2022, 2, 18, 19, 8, 37, 958, DateTimeKind.Local).AddTicks(1929), "Brufen - 120, Palitreks - 90, Andol - 50", false },
                    { "3", new DateTime(2022, 1, 21, 19, 8, 37, 958, DateTimeKind.Local).AddTicks(1980), "Brufen - 2, Palitreks - 2, Andol - 2", true },
                    { "4", new DateTime(2021, 12, 31, 19, 8, 37, 958, DateTimeKind.Local).AddTicks(1984), "Brufen - 10, Palitreks - 50, Andol - 35", true }
                });

            migrationBuilder.InsertData(
                table: "DrugstoreOffers",
                columns: new[] { "Id", "Content", "DrugstoreName", "EndDate", "StartDate", "Title" },
                values: new object[] { "1", "Content", "Apotekica", new DateTime(2022, 1, 28, 19, 8, 37, 957, DateTimeKind.Local).AddTicks(4967), new DateTime(2022, 1, 28, 19, 8, 37, 955, DateTimeKind.Local).AddTicks(2624), "title" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Klik", new DateTime(2022, 1, 28, 19, 8, 37, 958, DateTimeKind.Local).AddTicks(3928) });
