    ...
    public class Room
    {
        ...
        public String TypeSerbian
        {
            get
            {
                switch (RoomType)
                {
                    case global::Hospital.RoomsAndEquipment.Model.RoomType.examinationRoom:
                        return "Soba za preglede";
                    case global::Hospital.RoomsAndEquipment.Model.RoomType.operatingRoom:
                        return "Operaciona sala";
                    case global::Hospital.RoomsAndEquipment.Model.RoomType.recoveryRoom:
